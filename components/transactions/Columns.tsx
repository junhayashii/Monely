    ...
    () => [
      {
        ...
        cell: ({ row }) => {
          ...
          const displayName = truncate(name, 20);
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          if (isTransfer) {
            return (
              <div className="text-right text-sm md:text-base text-sky-600 dark:text-sky-400 font-bold">
                {formatted}
              </div>
            );
          }
          ...
          if (isIncome) {
            return (
              <div className="text-right text-sm md:text-base text-emerald-600 dark:text-emerald-400 font-bold">
                +{formatted}
              </div>
            );
          }
          ...
          // Expense
          return (
            <div className="text-right text-sm md:text-base text-rose-600 dark:text-rose-400 font-bold">
              -{formatted}
            </div>
          );
        },
